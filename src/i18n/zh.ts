...
const zh: Translations = {
  ...
  welcome: {
    title: "离线书签管理器",
    description: "数据只保存在当前浏览器本地，不会上传到服务器。先导入浏览器书签文件，之后就可以在网页里整理、搜索、导出和备份。",
    import: "导入书签文件",
    example: "使用示例数据",
    processing: "正在处理书签数据...",
    importFailed: "导入失败，请确认文件是浏览器导出的 HTML 书签文件或本项目导出的 JSON 文件。",
    exampleFailed: "加载示例数据失败，请刷新页面后重试。",
    supportedFormatsTitle: "支持格式",
    supportedFormats: "Chrome / Edge / Firefox 导出的 HTML，或本项目导出的 JSON。",
    localStorageTitle: "本地存储",
    localStorageNote: "刷新页面后数据仍保留；清理浏览器站点数据会删除本地书签。",
    freeDeployTitle: "免费部署",
    freeDeployNote: "这是纯静态网页，可以部署到 GitHub Pages。",
  },
  header: {
    resetData: "重置数据",
    addColumn: "添加列",
